...
if (not(-z "01/CONTCAR") && (-e "01/CONTCAR")){
    $str = "CONTCAR";
} 
else {
    $str = "POSCAR";
...
print "$d0/$str and $d1/$str and $d2/$str and $d3/$str";

system "cp $d0/$str POSCAR0";
system "cp $d1/$str POSCAR1";
system "cp $d2/$str POSCAR2";
system "cp $d3/$str POSCAR3";
